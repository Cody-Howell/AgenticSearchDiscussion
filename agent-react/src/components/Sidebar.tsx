...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 h-full bg-emerald-950/60 border border-emerald-900/70 shadow-lg shadow-emerald-950/40 rounded-2xl backdrop-blur-sm shrink-0 overflow-hidden">
